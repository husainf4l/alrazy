    ...
    async def initialize(self):
        ...
        try:
            ...
            if self.config.get('llm_config', {}).get('enabled', False):
                self.llm_analyzer = LLMActivityAnalyzer(self.config['llm_config'])
            ...
            if self.activity_detector:
                logger.info("🔍 Activity detector initialized")
    ...
    async def _send_webhooks(self, activity: SuspiciousActivity, 
        ...
        try:
            ...
            webhook_data = {
                ...
                'timestamp': time.time(),
                'pharmacy_location': self.config.get('pharmacy_name', 'Al Razy Pharmacy')
            }
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'services': {
                ...
                'activity_detector': self.activity_detector is not None
            },
