  ...
  const defaultCameras: Camera[] = [
    {
      id: "1",
      name: "Front Entrance",
      url: "rtsp://admin:tt55oo77@149.200.251.12:554/Streaming/Channels/101",
      status: "loading",
    },
    {
      id: "2",
      name: "Parking Area",
      url: "rtsp://admin:tt55oo77@149.200.251.12:554/Streaming/Channels/201",
      status: "loading",
    },
    {
      id: "3",
      name: "Back Garden",
      url: "rtsp://admin:tt55oo77@149.200.251.12:554/Streaming/Channels/301",
      status: "loading",
    },
    {
      id: "4",
      name: "Side Yard",
      url: "rtsp://admin:tt55oo77@149.200.251.12:554/Streaming/Channels/401",
      status: "loading",
    },
  ];
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Camera {selectedCameraData.id} • 1080p • 30fps
                </p>
              </div>
            </div>
